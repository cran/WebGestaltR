...
This section describes the arguments of the WebGestaltR function:
      ...
      28. \emph{hostName}: The server URL for accessing the data. User can use \emph{listArchiveURL} function to get all archive version URL.
...
This section describes the arguments of the \emph{IDMapping} function:
      ...
      6. \emph{is_outputFile}: if is_outputFile is TRUE, the mapping results will be outputted to a file.
...
\subsection{Input}
This section describes the argument of the \emph{listGeneSet} function:
...
\subsection{Input}
This section describes the argument of the \emph{listIDType} function:
...
\subsection{Input}
This section describes the argument of the \emph{listReferenceSet} function:
